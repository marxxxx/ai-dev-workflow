...
dev box and CI). Pin to a Git tag (e.g. `#v0.2.0`) so devs and CI stay in sync.
...
npx github:marxxxx/ai-dev-workflow#v0.2.0 init
...
npx github:marxxxx/ai-dev-workflow#v0.2.0 generate

# 4. commit ai-project.json and the generated dirs
```

Pin the tag (`#v0.2.0`) so devs and CI stay in sync — a C# repo has no lockfile to do it for you.
...
```jsonc
"devDependencies": {
  "@strobl/ai-dev-workflow": "github:marxxxx/ai-dev-workflow#v0.2.0"
},
"scripts": {
